...
Create Date  : 2016-10-04
 ----------------------------------------------------------------------
 Class name  : mvc_menu_loader_manager
 Version     : 1.0
...
class mvc_menu_loader_manager extends mvc_std_loader_manager{
...
//**** Getter ******************************************************************   
  public  function getModel() {	return $this->obj_mvc_menu_loader;}
	public  function getMvcMenuLoader() {	return $this->mvc_menu_loader;}
  ...
  {  
   ...
   /*******************************************************************************
    ...
    {     
         ...
         $obj_model=new mvc_menu('',false);   
         
         //- ajout du modèle à la collection
         $this->obj_mvc_menu_loader->addToCollection($obj_model); 
   ...
   /*******************************************************************************
    ...
    {    
         ...
         $stri_post_name='mvc_menu__int_mm_id__delete';
         $bool_ok=true;
         $obj_loader= $this->obj_mvc_menu_loader;
                
         foreach($_POST[$stri_post_name] as $stri_val_pk)
         {
            //- création d'un sous-modèle
            $obj_sous_modele=new mvc_menu(array('MM_ID'=>$stri_val_pk),false);
