...
Create Date  : 2016-10-04       
 ----------------------------------------------------------------------
 Class name  : mvc_menu_loader
 Version     : 1.0
 Author      : SOLEILLANT Remy
 Description : Loader permettant de gérer une collection de modèle mvc_menu. 
 
********************************************************************************/
class mvc_menu_loader  extends mvc_std_loader {
...
//**** Attributs ****************************************************************
	...
	//*** Attributs modèle ********************************************************
	protected $arra_mvc_menu    ;  //Le tableau des modèles contenu dans le loader
	...
	*******************************************************************************/
	...
	{            
     ...
     //- Déclaration de manager
		$this->obj_manager=new mvc_menu_loader_manager($this);//initialisation du manager

		//- Déclaration du viewer
		$this->obj_viewer=new mvc_menu_loader_viewer($this);//initialisation du viewer
    ...
    //- Chargement par défaut des MVC dynamique        
     ...
     $this->obj_model_reference=new mvc_menu('',false);
     $this->obj_model_reference->getViewer()->setDisabled(true);//désactivation de l'ensemble des champs
    
     //- transmission des fk
     $this->obj_model_reference->setMmMenu($this->getIdMvc());
  ...
  /*******************************************************************************
	...
	*******************************************************************************/
	...
	{ 
		...
		$this->arra_mvc_menu=$arra_attribute;  
	}
...
//**** Getter ****************************************************************   
  public  function getCollection()  {	return $this->arra_mvc_menu   ;}
  ...
  /*******************************************************************************
	...
	*******************************************************************************/
	...
	{ 
     ...
     $this->arra_mvc_menu=$arra_collection; 
  }  
	...
	*******************************************************************************/
	...
	{ 
		...
		$stri_sql=" SELECT  *
            		FROM mvc_menu
            	--WHERE champ='".$this->getIdMvc()."'
                order by mm_menu, mm_item
            		"; 
