...
Create Date  : 2016-10-04       
 ...
 Description : Loader permettant de gérer une collection de modèle mvc_menu_imbrication. 
...
//**** Attributs ****************************************************************
	...
	//*** Attributs modèle ********************************************************
	protected $arra_mvc_menu_imbrication    ;  //Le tableau des modèles contenu dans le loader
...
//**** Setter ****************************************************************
 ...
 //Permet de changer le viewer à partir d'un nom de classe et de la méthode de représentation principal
  ...
  //Transmission de données à l'ensemble de la collection
...
//**** Getter ****************************************************************   
  ...
  //**** Gestion de la sélection ***********************************************   
   //Permet d'obtenir le tableau des éléments sélectionnés
   ...
   /**
    * Permet de sélectionner un ou plusieurs élément de la collection
    * @param :  $mixed_selected : stri  : l'identifiant de l'unique élément à sélectionner
    *                             array : tableau des identifiant des éléments à sélectionner    
    * @return : array : tableau des éléments sélectionnés 
    **/         
   ...
   { 
      ...
      //- parcours et sélection d'élément
      foreach($this->arra_mvc_menu_imbrication as $obj_mvc_menu_imbrication)
      {
