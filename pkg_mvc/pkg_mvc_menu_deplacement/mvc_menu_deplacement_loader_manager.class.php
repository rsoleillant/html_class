...
Create Date  : 2016-10-04
 ----------------------------------------------------------------------
 Class name  : mvc_menu_deplacement_loader_manager
 Version     : 1.0
...
class mvc_menu_deplacement_loader_manager extends mvc_std_loader_manager{
...
//**** Getter ******************************************************************   
  public  function getModel() {	return $this->obj_mvc_menu_deplacement_loader;}
	public  function getMvcMenuDeplacementLoader() {	return $this->mvc_menu_deplacement_loader;}
  ...
  {  
   ...
   /*******************************************************************************
    ...
    {       
         ...
         $obj_model=new mvc_menu_deplacement('',false);   
         
         //- ajout du modèle à la collection
         $this->obj_mvc_menu_deplacement_loader->addToCollection($obj_model); 
   ...
   /*******************************************************************************
    ...
    {    
         ...
         $stri_post_name='mvc_menu_deplacement__int_mmd_id__delete';
         $bool_ok=true;
         $obj_loader= $this->obj_mvc_menu_deplacement_loader;
                
         foreach($_POST[$stri_post_name] as $stri_val_pk)
         {
            //- création d'un sous-modèle
            $obj_sous_modele=new mvc_menu_deplacement(array('MMD_ID'=>$stri_val_pk),false);
