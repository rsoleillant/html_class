...
/* * *****************************************************************************
  ...
  Description : Permet l'affichage du bloc détails
...
//*** Méthodes d'affichage ****************************************************
    ...
    public function htmlValue() {
        ...
        if ($this->bool_scroll)
        {
             ...
             //Permet de faire flotter la div détails lors d'un scroll sur l'écran
            echo "
            <script>
            $(document).ready(function () {  
                ...
                function getEndMod()
                {
                    ...
                    //Récupere et retourne le top du flag en_mod défini dans 
