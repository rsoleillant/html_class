...
Create Date : 22/05/2006
 ...
 Class name : file
 Version : 1.1
 Author : Romain ROBERT Soleillant
 Description : élément html <input type='file'>
 *              Permet d'upload les fichiers via un input type file [] array
********************************************************************************/

class file_uploader_array 
{   
  //**** attribute ************************************************************
  ...
  protected $int_index;                     //Index de $_FILES
  
  //**** constructor ***********************************************************
  function __construct($local_name,$server_name,$server_directory,$extension,$index,$max_size=999999999) 
  {    
  ...
  public function extensionVerification()
  {
    ...
    $stri_file_name=$_FILES[$this->stri_file_local_name]['name'][$this->int_index];
  ...
  public function sizeVerification()
  {
    ...
    if($_FILES[$this->stri_file_local_name]['size'][$this->int_index]>$this->int_max_size)
    {
      $bool_ok=false;
    }
    return $bool_ok;
  ...
  public function upload()
  {
    ...
    if( !is_uploaded_file($_FILES[$this->stri_file_local_name]['tmp_name'][$this->int_index]))
    {
      $this->stri_error_message=_ERROR_FILE_NOT_UPLOADED;
      echo "<font color='red'><b>"._ERROR_FILE_NOT_UPLOADED."<br></b></font>";
    //  return false;
    }
    else if(!$this->extensionVerification())
    {
      ...
      echo "<font color='red'><b>"._ERROR_EXTENSION."<br></b></font>";
    }
    ...
    else if(!move_uploaded_file($_FILES[$this->stri_file_local_name]['tmp_name'][$this->int_index],
    $this->stri_server_directory.$this->stri_file_server_name))
    { 
        
      $this->stri_error_message=_ERROR_DIRECTORY;
      echo "<font color='red'><b>"._ERROR_DIRECTORY."<br></b></font>";
    }   
    else if(!is_file($this->stri_server_directory.$this->stri_file_server_name))
    {
       ...
       echo "<font color='red'><b>"._ERROR_FILE_UNAVAILABLE_ON_SERVER."<br></b></font>";
    }
