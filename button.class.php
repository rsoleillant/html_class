...
Create Date : 22/05/2006
 ...
 Description : élément html <input type='button'>
********************************************************************************/
...
class button extends input 
{
  ...
  function __construct($name,$value) 
  {
    ...
    //@param : $value => [string] le libellé du bouton
    //@return : void
  ...
  {
    //sérialisation de l'objet button et de la classe mère  
  ...
  {
    //désérialisation de l'objet button et de la classe mère
